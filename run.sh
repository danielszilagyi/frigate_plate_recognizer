...
export license_plate_min_score="$(bashio::config 'frigate.license_plate_min_score')"
...
yq --inplace e '.frigate.license_plate_min_score = env(license_plate_min_score)' "${CONFIG_PATH}"
